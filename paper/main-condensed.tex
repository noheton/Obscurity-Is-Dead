...
nineteen clusters by 2026-05-04, the FAIR metadata, and the
redaction policy that govern this paper. \emph{Full
...
\seqsplit{\texttt{[edge-case]}} verification status in
\texttt{docs/sources.md} --- load-bearing, first-of-its-kind,
awaiting human \seqsplit{\texttt{[lit-read]}} --- and are invoked
