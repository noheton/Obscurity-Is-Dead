...
\fcolorbox{black!40}{black!4}{\parbox{0.92\linewidth}{\centering
  ...
  prompts, and the FAIR / FAIR4AI metadata --- and are referenced where a
...
ladder stage (\texttt{[needs-research]} $\rightarrow$
...
one rather than retrofitted, with the proposed \emph{FAIR4AI} extension
below as an explicit forward direction.
