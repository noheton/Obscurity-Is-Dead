...
data-driven heat-map (Rule-14 compliant; ILL-06). The two **logo
assets** (`logo-obscurity-is-dead.png` and
`logo-pandora-jar-intact.png`) were generated by **Google Gemini** at
the author's request on 2026-05-02 and are committed as the project's
visual identity; they are not part of the figure-numbering sequence
and their binaries are researcher-supplied (rule 1: AI contributions
