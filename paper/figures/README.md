...
**Figures 8, 9, 11 are AI-authored programmatic diagrams** (illustration
agent, `docs/prompts/illustration-prompt.md`, 2026-05-02): produced in
response to the Illustration Opportunities Registry (ILL-02, ILL-03,
ILL-05). They encode structural relationships rather than numerical
data; their generation scripts are committed for reproducibility.
...
### Figures 8, 9, 11 — AI-authored programmatic diagrams
