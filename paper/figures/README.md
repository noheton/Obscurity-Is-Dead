...
editor, not generated from data scripts) and are exempt from the Rule-15
...
satisfy Rule 15 — both are 4×-cited paper figures and were the highest-
...
**Figures 1 and 10 are data-driven** and are Rule-15 compliant: see
...
reproducibility. **Figure 12** is a data-driven heat-map (Rule-15
...
machine-readable data. They are documented here per the Rule-15 exemption
...
in a future session, the Rule-15 table above must be updated.
...
most-cited paper figures (4× each) now satisfy CLAUDE.md rule 15
...
4. Update this README with a new row in the Rule-15 compliance table.
...
- **Toolchain coverage.** Every figure in the set is currently
  ...
  rule-15-exempt). If a new toolchain path (Mermaid / TikZ /
