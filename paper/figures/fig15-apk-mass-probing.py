...
ax.add_patch(FancyBboxPatch((0.6, panel_y - 0.95), 12.0, 1.55,
                            boxstyle="round,pad=0.04,rounding_size=0.10",
                            fc="#fff8be", ec=dlr_style.DLR_HAIRLINE, lw=1.0))
...
ax.text(3.4, panel_y - 0.10,
        ...
        ha="center", va="center", fontsize=8.4, color="#222")
...
ax.text(6.5, panel_y - 0.65,
        ...
        ha="center", va="center", fontsize=8.4, style="italic",
        color=dlr_style.DLR_GRAY)
