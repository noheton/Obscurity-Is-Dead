...
A short methodological note from me (Florian Krebs), placed up-front because *how* you read this paper matters as much as *what* is in it. Treat the note as an invitation — to read closely, to argue back, and to bring evidence. The four short framings below are the lenses I would most want a thoughtful reader to bring to the rest of the document; none of them softens an empirical claim, and all of them open a door to discussion.
