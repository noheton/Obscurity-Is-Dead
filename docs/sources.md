...
- Reference: `SpiderBLEBridge-master.zip` cited in `REPORT.md` §3 and transcript T1.
- URL: not recorded in repo.
...
- Type: community open-source implementation.
- Reference: `PythonSpiderController-main.zip` cited in `REPORT.md` §3 and transcript T1.
- URL: not recorded in repo.
- Status: **[repo-verified]**.
