...
[![GitHub release](https://img.shields.io/github/release/[REDACTED:repo-path:EF-IMPL-1]?include_prereleases=&sort=semver&color=blue)](https://github.com/[REDACTED:repo-path:EF-IMPL-1]/releases/)
[![issues - powerocean](https://img.shields.io/github/issues/[REDACTED:repo-path:EF-IMPL-1])](https://github.com/[REDACTED:repo-path:EF-IMPL-1]/issues)
[![GH-code-size](https://img.shields.io/github/languages/code-size/[REDACTED:repo-path:EF-IMPL-1]?color=red)](https://github.com/[REDACTED:repo-path:EF-IMPL-1])
[![GH-last-commit](https://img.shields.io/github/last-commit/[REDACTED:repo-path:EF-IMPL-1]?style=flat-square)](https://github.com/[REDACTED:repo-path:EF-IMPL-1]/commits/main)
[![hacs_badge](https://img.shields.io/badge/HACS-Custom-41BDF5.svg)](https://github.com/hacs/integration)
[![HACS validation](https://github.com/[REDACTED:repo-path:EF-IMPL-1]/workflows/Validate/badge.svg)](https://github.com/[REDACTED:repo-path:EF-IMPL-1]/actions?query=workflow:"Validate")
...
2. Add `https://github.com/[REDACTED:repo-path:EF-IMPL-1]` with category **Integration**
