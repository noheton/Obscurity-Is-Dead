...
> ESPHome component ([REDACTED:maintainer-handle:SF-IMPL-1]) · schedule-4-real (EddiePiazza) ·
...
{
  "method": "<method>",
  "pid":    "<MAC without colons, e.g. [REDACTED:serial:S-SF-device]>",
  "pcode":  1004,
...
curl http://[REDACTED:ip:S-SF-device]:18083/api/v5/clients

# List subscriptions for the device client
curl http://[REDACTED:ip:S-SF-device]:18083/api/v5/clients/<clientid>/subscriptions
```
