...
> Sources: live MQTT captures, BLE reverse engineering (cr0ssn0tice), ESPHome component ([REDACTED:maintainer-handle:SF-IMPL-1]), schedule-4-real (EddiePiazza), Spider Farmer product manuals (GGS System, G-Series, Inline Fan, Clip Fan, Heater)
...
{
  "method": "<method>",
  "pid":    "<MAC address of controller, e.g. [REDACTED:serial:S-SF-device]>",
  "pcode":  1004,
