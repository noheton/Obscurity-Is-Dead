...
- `esphome-spiderfarmer_ble-encrypt.zip` — ESPHome C++ component (smurfy)
- `SpiderBLEBridge-master.zip` — Arduino/ESP32 bridge (p0rigth-dev)
- `PythonSpiderController-main.zip` — Python + MQTT bridge
