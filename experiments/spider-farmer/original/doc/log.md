...
- Tries to auth with user: `sf_ggs_cb`
- But I am still looking for the password, so my server denies connection. The password might be `euuavURS4Kp9bMUfYmvwl`, but that does not seem to work.
...
The password is actually `euuavURS4Kp9bMUfYmvwl-` (notice the dash at the end)
