...
> 2. ES-6 source (`arska/controlmyspa`, PyPI v4.0.0 / 2025-08-23,
>    MIT) — fetched via WebFetch.
> 3. ES-7 source (`mikakoivisto/controlmyspa-ha-mqtt`) — surveyed
