...
cloud projects (`arska/controlmyspa`,
`mikakoivisto/controlmyspa-ha-mqtt`, an HA-community thread, a
...
(`arska/controlmyspa`) and reveals new endpoints
...
the existing upstream `mikakoivisto/controlmyspa-ha-mqtt` MQTT
bridge.
